...
// Get client's job counts
$clientId = $_SESSION['user']['id'];
$sql = "SELECT COUNT(*) AS total_jobs FROM jobs WHERE client_id = $clientId";
...
$sql1 = "SELECT COUNT(DISTINCT d.job_id) AS active_jobs
         FROM deliveries d
         JOIN jobs j ON d.job_id = j.id
         WHERE j.client_id = $clientId AND d.status = 'approved'";
...
if ($result1 && mysqli_num_rows($result1) > 0) {
    ...
    $activeJobs = $row1['active_jobs'];
}



// Get average freelancer rating
$sql2 = "SELECT AVG(freelancer_rating) AS avg_rating FROM applications WHERE client_id = $clientId AND freelancer_rating IS NOT NULL";
...
<head>
    ...
    <title>Client Dashboard | Wonder Connect</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="welcome">
                <h1>Welcome back, <?= htmlspecialchars($client_name) ?>!</h1>
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="../images/free1.jpg" class="slide-img" alt="Client Dashboard">
                    ...
                    <div class="swiper-slide">
                        <img src="../images/free2.jpg" class="slide-img" alt="Manage Projects">
                        <div class="slide-content">
                            <h3>Manage Your Projects</h3>
                            <p>Track progress and communicate with freelancers</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <img src="../images/free3.jpg" class="slide-img" alt="Review Work">
                        <div class="slide-content">
                            <h3>Review Completed Work</h3>
                            <p>Provide feedback and ratings for freelancers</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="stats-grid">
            ...
            <!--<div class="stat-card">
                ...
                <p><?php echo number_format($avgRating, 1); ?></p>
            </div>
        </div>
        ...
        <div class="actions-grid">
            <div class="action-card">
                ...
                <h3>Post a Job</h3>
                <p>Create a new job posting to find the perfect freelancer</p>
            ...
            <div class="action-card">
                ...
                <p>Review freelancer applications for your jobs</p>
                <a href="view_applications.php" class="btn">View Requests</a>
            </div>
        </div>
    </div>
