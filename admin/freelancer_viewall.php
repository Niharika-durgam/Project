...
<head>
    ...
    <title>Admin - Freelancers | Wonder Connect</title>
        ...
        <div class="main-content">
            ...
            <div class="table-container">
                <div class="user-tabs-wrapper">
                    <div class="user-tabs">
                        <div class="user-tab active">Freelancers (<?= $freelancerCount ?>)</div>
                    </div>
                    
                    <!-- Freelancers Tab -->
                    <div id="freelancers-tab" class="user-tab-content active">
                            ...
                            <table class="user-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="user-name">
                                                <img src="<?= !empty($freelancer['profile_pic']) ? '../uploads/profile_pics/' . htmlspecialchars($freelancer['profile_pic']) : 'https://ui-avatars.com/api/?name=' . urlencode($freelancer['name']) . '&background=6c63ff&color=fff' ?>" 
                                                     alt="<?= htmlspecialchars($freelancer['name']) ?>" class="user-avatar">
                                                <?= htmlspecialchars($freelancer['name']) ?>
                                            </div>
                                        </td>
                                        <td><?= htmlspecialchars($freelancer['email']) ?></td>
                                        <td><?= !empty($freelancer['skills']) ? htmlspecialchars($freelancer['skills']) : 'Not specified' ?></td>
                                        <td><?= date('M d, Y', strtotime($freelancer['created_at'])) ?></td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
                            </table>
